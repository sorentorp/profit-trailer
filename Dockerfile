...
ADD https://github.com/taniman/profit-trailer/releases/download/2.5.18/ProfitTrailer-2.5.18.zip /app

RUN unzip -jqd /app /app/ProfitTrailer-2.5.18.zip ProfitTrailer-2.5.18/ProfitTrailer.jar && \
    rm /app/ProfitTrailer-2.5.18.zip
