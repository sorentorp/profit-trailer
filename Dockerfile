...
ADD https://github.com/taniman/profit-trailer/releases/download/2.5.53/ProfitTrailer-2.5.53.zip /app

RUN unzip -jqd /app /app/ProfitTrailer-2.5.53.zip ProfitTrailer-2.5.53/ProfitTrailer.jar && \
    rm /app/ProfitTrailer-2.5.53.zip
