...
ADD https://github.com/taniman/profit-trailer/releases/download/2.5.9/ProfitTrailer-2.5.9.zip /app

RUN unzip -jqd /app /app/ProfitTrailer-2.5.9.zip ProfitTrailer-2.5.9/ProfitTrailer.jar && \
    rm /app/ProfitTrailer-2.5.9.zip
