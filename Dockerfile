...
ADD https://github.com/taniman/profit-trailer/releases/download/2.5.23/ProfitTrailer-2.5.23.zip /app

RUN unzip -jqd /app /app/ProfitTrailer-2.5.23.zip ProfitTrailer-2.5.23/ProfitTrailer.jar && \
    rm /app/ProfitTrailer-2.5.23.zip
