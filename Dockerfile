...
ADD https://github.com/taniman/profit-trailer/releases/download/2.5.17/ProfitTrailer-2.5.17.zip /app

RUN unzip -jqd /app /app/ProfitTrailer-2.5.17.zip ProfitTrailer-2.5.17/ProfitTrailer.jar && \
    rm /app/ProfitTrailer-2.5.17.zip
